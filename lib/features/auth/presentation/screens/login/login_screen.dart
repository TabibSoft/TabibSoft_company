          ...
          : BlocConsumer<LoginCubit, LoginState>(
              listener: (context, state) async {
                if (state.status == LoginStatus.success) {
                  ...
                  print('Token saved: ${state.data!.token}'); // تصحيح للتحقق
...
//               listener: (context, state) async {
//                 if (state.status == LoginStatus.success) {
//                   // حفظ التوكن واسم المستخدم باستخدام SharedPreferences (CacheHelper)
//                   await CacheHelper.saveData(
//                     key: 'loginToken',
//                     value: state.data!.token,
//                   );
//                   await CacheHelper.saveData(
//                     key: 'userName',
//                     value: state.data!.user.name, // التعديل هنا للحصول على الاسم الصحيح من الكائن user
//                   );
//                   Navigator.of(context).pushReplacement(
